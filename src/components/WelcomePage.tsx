    ...
    <>
      ...
      <div className="body-container">
        ...
        <div className="body-title">
            <p>WELCOME TO SEBITJA <br /> SECONDARY SCHOOL</p>
            <h5>Lorem ipsum dolor sit amet consectetur. Lectus scelerisque <br /> neque turpis vitae turpis sodales sed lectus.</h5>
        </div>
